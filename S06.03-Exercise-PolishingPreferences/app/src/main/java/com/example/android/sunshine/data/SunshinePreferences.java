...
public class SunshinePreferences {
    ...
    public static boolean isMetric(Context context) {
        ...
        String value = context.getString(R.string.pref_units_metric);
        String preferredMetric = sharedPreferences.getString(key,value);
        return value.equals(preferredMetric)?true:false;
    }
