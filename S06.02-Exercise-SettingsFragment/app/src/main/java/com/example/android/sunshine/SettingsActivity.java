...
public class SettingsActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // DONE (2) Create an pref_general resource directory
        // DONE (3) Add a PreferenceScreen with an EditTextPreference and ListPreference within the newly created pref_general resource directory
        ...
        // DONE (5) Override onCreatePreferences and add the preference pref_general file using addPreferencesFromResource
