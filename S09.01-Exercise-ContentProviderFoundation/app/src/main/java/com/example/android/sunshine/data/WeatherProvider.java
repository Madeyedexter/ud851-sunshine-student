...
//  DONE (8) Provide an implementation for the query method
    ...
    public Cursor query(@NonNull Uri uri, String[] projection, String selection,
        ...
        Cursor cursor = null;
        switch (match){
            case CODE_WEATHER: cursor = db.query(WeatherContract.WeatherEntry.TABLE_NAME,projection,selection,selectionArgs,null,null,sortOrder);
                break;
            case CODE_WEATHER_WITH_DATE:
                cursor = db.query(WeatherContract.WeatherEntry.TABLE_NAME,projection, WeatherContract.WeatherEntry.COLUMN_DATE+" = ?",new String[]{uri.getPathSegments().get(1)},null,null,sortOrder);
                break;
